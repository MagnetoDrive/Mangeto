    ...
    <div className="space-y-6">
      ...
      {isLoading ? (
        ...
        <div className="py-16 text-center border border-dashed border-slate-800 rounded-xl space-y-3">
          ...
          <p className="text-sm text-slate-400 font-semibold">Mangeto: Pull attention. Keep it.</p>
          <p className="text-xs text-slate-500 max-w-sm mx-auto font-mono">
            Input your concept profile on the left control panel, then press "Formulate 15 Hooks" or brainstorm with Mangeto Copilot.
          </p>
        </div>
      ) : (
